...
pub fn common_for(locale: Locale, en: &'static str) -> &'static str {
    let (zh_cn, zh_tw) = match en {
        ...
        "New project" => ("新建项目", "新增專案"),
        "Project path" => ("项目路径", "專案路徑"),
        "Open project" => ("打开项目", "開啟專案"),
        "Opening..." => ("打开中…", "開啟中…"),
        "Project added" => ("项目已添加", "專案已新增"),
        "Usage Statistics" => ("用量统计", "用量統計"),
        "Projects" => ("项目", "專案"),
        "Collapse projects" => ("折叠项目", "摺疊專案"),
        "Expand projects" => ("展开项目", "展開專案"),
        "Search sessions" => ("搜索会话", "搜尋工作階段"),
        "Close search" => ("关闭搜索", "關閉搜尋"),
        "No matching sessions" => ("没有匹配的会话", "沒有相符的工作階段"),
        "Settings" => ("设置", "設定"),
        "Hosts" => ("主机", "主機"),
