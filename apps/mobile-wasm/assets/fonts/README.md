# Inter Variable Mobile Runtime Fonts
...
by the desktop GPUI shell. The GPUI-WASM font parser used by the mobile runtime
rejects WOFF2, so the runtime embeds the equivalent decompressed font data.
...
fonttools ttLib.woff2 decompress \
  ...
  -o apps/mobile-wasm/assets/fonts/inter-latin-wght-normal.ttf
fonttools ttLib.woff2 decompress \
  ...
  -o apps/mobile-wasm/assets/fonts/inter-latin-ext-wght-normal.ttf
```
