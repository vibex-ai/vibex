...
use url::Url;
use vibex_core::{
    RemoteCreatePairingOfferResponse, RemoteDevicePermissionLevel, RemotePairingOfferSummary,
    RemotePairingTransport, RequestId, VibexError, VibexResult, unix_timestamp_ms,
};
...
const DIALOG_MAX_WIDTH: f32 = 720.0;
const DIALOG_MAX_HEIGHT: f32 = 680.0;
...
impl RemoteAccessPairing {
    ...
    fn render_method_selector(&self, cx: &mut Context<Self>) -> AnyElement {
        ...
        TabBar::new("remote-access-methods")
            ...
            .children(RemoteConnectivityMethod::ALL.into_iter().map(|method| {
                Tab::new()
                    .flex_1()
