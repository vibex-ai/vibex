...
pub fn strings(locale: ResolvedLocale) -> Strings {
    match locale {
        ResolvedLocale::En => Strings {
            ...
            network_proxy: "Proxy",
            network_proxy_description: "HTTP, HTTPS, and SOCKS5, used for model requests, the extension marketplace, updates, and the built-in browser.",
        ...
        ResolvedLocale::ZhCn => Strings {
            ...
            network_proxy: "代理",
            network_proxy_description: "HTTP、HTTPS 和 SOCKS5，用于模型请求、扩展市场、更新和内置浏览器。",
        ...
        ResolvedLocale::ZhTw => Strings {
            ...
            network_proxy: "代理",
            network_proxy_description: "HTTP、HTTPS 和 SOCKS5，用於模型請求、擴充市集、更新與內建瀏覽器。",
            network_proxy_url: "代理 URL",
