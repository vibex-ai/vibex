...
pub struct Strings {
    ...
    pub network_proxy_hint: &'static str,
...
pub fn strings(locale: ResolvedLocale) -> Strings {
    match locale {
        ResolvedLocale::En => Strings {
            ...
            network_proxy_description: "Route Vibex network requests and Agent tools through a local or enterprise proxy.",
            network_proxy_enabled: "Enable network proxy",
            network_proxy_placeholder: "http://127.0.0.1:7890",
            network_proxy_hint: "Supports http, https, socks5, and socks5h proxy URLs.",
            network_proxy_required: "Enter a proxy address to enable the network proxy.",
        ...
        ResolvedLocale::ZhCn => Strings {
            ...
            network_proxy: "网络代理",
            network_proxy_description: "通过本地或企业代理转发 Vibex 网络请求和 Agent 工具请求。",
            network_proxy_enabled: "启用网络代理",
            network_proxy_placeholder: "http://127.0.0.1:7890",
            network_proxy_hint: "支持 http、https、socks5 和 socks5h 代理地址。",
            network_proxy_required: "启用网络代理前请输入代理地址。",
        ...
        ResolvedLocale::ZhTw => Strings {
            ...
            network_proxy: "網路代理",
            network_proxy_description: "透過本機或企業代理轉送 Vibex 網路請求與 Agent 工具請求。",
            network_proxy_enabled: "啟用網路代理",
            network_proxy_placeholder: "http://127.0.0.1:7890",
            network_proxy_hint: "支援 http、https、socks5 和 socks5h 代理位址。",
            network_proxy_required: "啟用網路代理前請輸入代理位址。",
