...
impl ResolvedLocale {
    ...
    /// Compact code for the resolved-locale cache.
...
/// The process-wide resolved locale.
///
/// Resolving a locale from the system tag allocates twice
/// ([`SharedLocale::from_system_tag`] lowercases and rewrites the tag), and
/// `text()` is called around a thousand times per rendered frame. The answer
/// only changes when [`apply_locale`] runs, so it is resolved once there and
/// read back as a plain atomic afterwards.
static CURRENT_LOCALE: AtomicU8 = AtomicU8::new(ResolvedLocale::En.code());
...
pub struct Strings {
    ...
    pub agent_waiting_confirmation: &'static str,
    pub agent_expand_process: &'static str,
    pub agent_collapse_process: &'static str,
    pub new_session_slogan: &'static str,
    ...
    pub close_to_tray_description: &'static str,
    pub network_proxy: &'static str,
    pub network_proxy_description: &'static str,
    pub network_proxy_url: &'static str,
    pub network_proxy_url_description: &'static str,
    pub network_proxy_bypass: &'static str,
    pub network_proxy_bypass_description: &'static str,
    pub network_proxy_test: &'static str,
    pub network_proxy_test_description: &'static str,
    pub network_proxy_testing: &'static str,
    pub network_proxy_placeholder: &'static str,
    pub network_proxy_required: &'static str,
    pub network_proxy_invalid: &'static str,
    pub direct: &'static str,
    pub custom: &'static str,
    pub tray_open_vibex: &'static str,
    pub tray_quit_vibex: &'static str,
    ...
    pub light_theme_description: &'static str,
    pub dark_theme: &'static str,
    pub dark_theme_description: &'static str,
    ...
    pub window_scale: &'static str,
    pub window_scale_description: &'static str,
    pub decrease_window_scale: &'static str,
    pub increase_window_scale: &'static str,
    ...
    pub show_agent_generation_status: &'static str,
    pub show_agent_generation_status_description: &'static str,
    ...
    pub reasoning_display_mode: &'static str,
    pub reasoning_display_mode_description: &'static str,
    pub reasoning_display_latest: &'static str,
    pub reasoning_display_timeline: &'static str,
    pub reasoning_expanded_by_default: &'static str,
    pub reasoning_expanded_by_default_description: &'static str,
    ...
    pub command_palette_open: &'static str,
    pub command_palette_placeholder: &'static str,
    pub command_palette_recent: &'static str,
    pub command_palette_sessions: &'static str,
    pub command_palette_agents: &'static str,
    pub command_palette_agent_config_hint: &'static str,
    pub command_palette_settings: &'static str,
    pub command_palette_actions: &'static str,
    pub command_palette_no_results: &'static str,
    pub command_palette_loading: &'static str,
    ...
    /// Default name stem for a new session group; the ordinal is appended.
    pub sidebar_group_stem: &'static str,
    pub sidebar_group_rename_placeholder: &'static str,
    pub sidebar_group_rename_empty: &'static str,
    pub sidebar_group_new_from_selection: &'static str,
    pub sidebar_group_add_to: &'static str,
    pub sidebar_group_remove_from: &'static str,
    pub sidebar_group_dissolve: &'static str,
    pub sidebar_group_auto_continue: &'static str,
    pub sidebar_group_merge_panes: &'static str,
    pub sidebar_group_split_pane: &'static str,
    pub sidebar_group_confirm_delete: &'static str,
    pub sidebar_group_other_worktree: &'static str,
...
/// The copy table for `locale`.
///
/// One static per language: the table is a few kilobytes of `&'static str`
/// fields, and the renderer reads it many times per frame, so it is never
/// rebuilt or copied — callers borrow the table for the process lifetime.
pub fn strings(locale: ResolvedLocale) -> &'static Strings {
    match locale {
        ResolvedLocale::En => &STRINGS_EN,
        ResolvedLocale::ZhCn => &STRINGS_ZH_CN,
        ResolvedLocale::ZhTw => &STRINGS_ZH_TW,
    }
}
...
static STRINGS_EN: Strings = Strings {
    ...
    agent_waiting_confirmation: "Waiting for confirmation...",
    agent_expand_process: "Expand reasoning",
    ...
    close_to_tray_description: "Keep Vibex available in the system tray when the main window is closed.",
    network_proxy: "Proxy",
    network_proxy_description: "Choose how Vibex reaches the network: Agent requests, Git and terminal commands, Agent installs, and updates.",
    network_proxy_url: "Proxy URL",
    network_proxy_url_description: "Supports http, https, socks5, and socks5h proxy addresses.",
    network_proxy_bypass: "Bypass list",
    network_proxy_bypass_description: "Hosts that skip the proxy.",
    network_proxy_test: "Test",
    network_proxy_test_description: "Reach the Vibex release feed through the proxy to confirm the configuration works.",
    network_proxy_testing: "Testing…",
    network_proxy_placeholder: "http://127.0.0.1:7890",
    network_proxy_required: "Enter a proxy address to use a custom proxy.",
    network_proxy_invalid: "Enter a valid http(s) or socks5 proxy address.",
    direct: "Direct",
    custom: "Custom",
    tray_open_vibex: "Open Vibex",
    tray_quit_vibex: "Quit Vibex",
    appearance: "Appearance",
    appearance_description: "Choose how Vibex looks. These settings stay on this device.",
    ...
    light_theme_description: "Used whenever the appearance above resolves to light.",
    dark_theme: "Dark theme",
    dark_theme_description: "Used whenever the appearance above resolves to dark.",
    system: "System",
    ...
    window_scale_description: "Scales the entire desktop interface on this device.",
    decrease_window_scale: "Decrease window scale",
    increase_window_scale: "Increase window scale",
    ...
    show_agent_generation_status: "Agent generation status",
    show_agent_generation_status_description: "Show the current Agent phase, elapsed time, tool calls and token speed above the composer while generating.",
    ...
    reasoning_display_mode: "Reasoning display",
    reasoning_display_mode_description: "Choose whether live reasoning stays at the bottom or remains in the conversation timeline.",
    reasoning_display_latest: "Latest at bottom",
    reasoning_display_timeline: "In timeline",
    reasoning_expanded_by_default: "Expand reasoning by default",
    reasoning_expanded_by_default_description: "Open reasoning content by default; collapsed content can always be expanded from its row.",
    ...
    command_palette_open: "Global search",
    command_palette_placeholder: "Search sessions, agents, settings, and actions",
    command_palette_recent: "Recent sessions",
    command_palette_sessions: "Sessions",
    command_palette_agents: "Agents",
    command_palette_agent_config_hint: "Open in Config Center",
    command_palette_settings: "Settings",
    command_palette_actions: "Quick actions",
    command_palette_no_results: "No matching sessions, agents, settings, or actions",
    command_palette_loading: "Indexing session content…",
    command_palette_hint: "↑↓ to navigate · ↵ to open · Esc to close",
    command_palette_close: "Close search",
    ...
    sidebar_group_stem: "Session group",
    sidebar_group_rename_placeholder: "Session group name",
    sidebar_group_rename_empty: "Enter a session group name.",
    sidebar_group_new_from_selection: "New session group",
    sidebar_group_add_to: "Add to session group",
    sidebar_group_remove_from: "Remove from session group",
    sidebar_group_dissolve: "Dissolve session group",
    sidebar_group_auto_continue: "Auto continue (all sessions)",
    sidebar_group_merge_panes: "Merge panes",
    sidebar_group_split_pane: "Split pane",
    sidebar_group_confirm_delete: "Delete session group?",
    sidebar_group_other_worktree: "A session group can only hold sessions from one Worktree.",
...
static STRINGS_ZH_CN: Strings = Strings {
    ...
    agent_waiting_confirmation: "等待确认中...",
    agent_expand_process: "展开推理过程",
    ...
    close_to_tray_description: "关闭主窗口后，让 Vibex 继续在系统托盘中运行。",
    network_proxy: "代理",
    network_proxy_description: "选择 Vibex 访问网络的方式：Agent 请求、Git 与终端命令、Agent 安装和更新。",
    network_proxy_url: "代理 URL",
    network_proxy_url_description: "支持 http、https、socks5 和 socks5h 代理地址。",
    network_proxy_bypass: "绕过列表",
    network_proxy_bypass_description: "不走代理的主机。",
    network_proxy_test: "测试",
    network_proxy_test_description: "通过代理访问 Vibex 发布源，确认当前配置可用。",
    network_proxy_testing: "正在测试…",
    network_proxy_placeholder: "http://127.0.0.1:7890",
    network_proxy_required: "使用自定义代理前请输入代理地址。",
    network_proxy_invalid: "请输入有效的 http(s) 或 socks5 代理地址。",
    direct: "直连",
    custom: "自定义",
    tray_open_vibex: "打开 Vibex",
    tray_quit_vibex: "退出 Vibex",
    appearance: "外观",
    appearance_description: "选择 Vibex 的外观。这些设置只保存在此设备上。",
    session_settings: "会话",
    ...
    dark: "深色",
    light_theme: "浅色主题",
    light_theme_description: "当上方外观为浅色时使用。",
    dark_theme: "深色主题",
    dark_theme_description: "当上方外观为深色时使用。",
    system: "跟随系统",
    system_default: "系统默认",
    language: "语言",
    ...
    traditional_chinese: "繁體中文",
    window_scale: "窗口缩放比例",
    window_scale_description: "调整此设备上整个桌面界面的缩放比例。",
    decrease_window_scale: "缩小窗口界面",
    increase_window_scale: "放大窗口界面",
    interface_font: "界面字体",
    ...
    show_agent_generation_status: "Agent 生成状态",
    show_agent_generation_status_description: "生成期间在输入框上方显示当前 Agent 阶段、耗时、工具调用次数和 Token 速度。",
    ...
    reasoning_display_mode: "推理显示方式",
    reasoning_display_mode_description: "选择将实时推理固定在底部，或保留在会话时间线中。",
    reasoning_display_latest: "最新内容置底",
    reasoning_display_timeline: "显示在时间线",
    reasoning_expanded_by_default: "默认展开推理",
    reasoning_expanded_by_default_description: "默认打开推理内容；折叠内容仍可在对应行展开。",
    ...
    command_palette_open: "全局搜索",
    command_palette_placeholder: "搜索会话、Agent、设置项和快捷操作",
    command_palette_recent: "最近会话",
    command_palette_sessions: "会话",
    command_palette_agents: "Agent",
    command_palette_agent_config_hint: "打开配置中心",
    command_palette_settings: "设置",
    command_palette_actions: "快捷操作",
    command_palette_no_results: "没有匹配的会话、Agent、设置项或快捷操作",
    command_palette_loading: "正在索引会话内容…",
    command_palette_hint: "↑↓ 选择 · ↵ 打开 · Esc 关闭",
    command_palette_close: "关闭搜索",
    ...
    sidebar_group_stem: "会话组",
    sidebar_group_rename_placeholder: "会话组名称",
    sidebar_group_rename_empty: "请输入会话组名称。",
    sidebar_group_new_from_selection: "新建会话组",
    sidebar_group_add_to: "加入会话组",
    sidebar_group_remove_from: "移出会话组",
    sidebar_group_dissolve: "解散会话组",
    sidebar_group_auto_continue: "自动继续（组内全部会话）",
    sidebar_group_merge_panes: "合并面板",
    sidebar_group_split_pane: "分屏",
    sidebar_group_confirm_delete: "删除会话组？",
    sidebar_group_other_worktree: "会话组只能包含同一个 Worktree 下的会话。",
...
static STRINGS_ZH_TW: Strings = Strings {
    ...
    agent_worked_for: "工作了",
    agent_pending_response: "思考中...",
    agent_waiting_confirmation: "等待確認中...",
    agent_expand_process: "展開推理過程",
    ...
    close_to_tray_description: "關閉主視窗後，讓 Vibex 繼續在系統匣中執行。",
    network_proxy: "代理",
    network_proxy_description: "選擇 Vibex 存取網路的方式：Agent 請求、Git 與終端機命令、Agent 安裝與更新。",
    network_proxy_url: "代理 URL",
    network_proxy_url_description: "支援 http、https、socks5 和 socks5h 代理位址。",
    network_proxy_bypass: "繞過清單",
    network_proxy_bypass_description: "不走代理的主機。",
    network_proxy_test: "測試",
    network_proxy_test_description: "透過代理存取 Vibex 發佈來源，確認目前設定可用。",
    network_proxy_testing: "正在測試…",
    network_proxy_placeholder: "http://127.0.0.1:7890",
    network_proxy_required: "使用自訂代理前請輸入代理位址。",
    network_proxy_invalid: "請輸入有效的 http(s) 或 socks5 代理位址。",
    direct: "直連",
    custom: "自訂",
    tray_open_vibex: "開啟 Vibex",
    tray_quit_vibex: "結束 Vibex",
    appearance: "外觀",
    appearance_description: "選擇 Vibex 的外觀。這些設定只儲存在此裝置上。",
    session_settings: "會話",
    ...
    dark: "深色",
    light_theme: "淺色主題",
    light_theme_description: "當上方外觀為淺色時使用。",
    dark_theme: "深色主題",
    dark_theme_description: "當上方外觀為深色時使用。",
    system: "跟隨系統",
    system_default: "系統預設",
    language: "語言",
    ...
    traditional_chinese: "繁體中文",
    window_scale: "視窗縮放比例",
    window_scale_description: "調整此裝置上整個桌面介面的縮放比例。",
    decrease_window_scale: "縮小視窗介面",
    increase_window_scale: "放大視窗介面",
    interface_font: "介面字體",
    ...
    show_agent_generation_status: "Agent 生成狀態",
    show_agent_generation_status_description: "生成期間在輸入框上方顯示目前 Agent 階段、耗時、工具呼叫次數與 Token 速度。",
    session_content_width: "會話內容寬度",
    session_content_width_description: "控制會話訊息和下方輸入框的整體寬度。",
    session_content_width_narrow: "窄屏",
    session_content_width_standard: "標準",
    session_content_width_full: "全屏",
    reasoning_display_mode: "推理顯示方式",
    reasoning_display_mode_description: "選擇將即時推理固定在底部，或保留在會話時間線中。",
    reasoning_display_latest: "最新內容置底",
    reasoning_display_timeline: "顯示在時間線",
    reasoning_expanded_by_default: "預設展開推理",
    reasoning_expanded_by_default_description: "預設開啟推理內容；折疊內容仍可在對應列展開。",
    enhanced_command_execution_display: "命令卡片渲染",
    ...
    increase_font_weight: "增大字重",
    command_palette_open: "全域搜尋",
    command_palette_placeholder: "搜尋會話、Agent、設定項目與快捷操作",
    command_palette_recent: "最近會話",
    command_palette_sessions: "會話",
    command_palette_agents: "Agent",
    command_palette_agent_config_hint: "開啟配置中心",
    command_palette_settings: "設定",
    command_palette_actions: "快捷操作",
    command_palette_no_results: "沒有符合的會話、Agent、設定項目或快捷操作",
    command_palette_loading: "正在建立會話內容索引…",
    command_palette_hint: "↑↓ 選擇 · ↵ 開啟 · Esc 關閉",
    command_palette_close: "關閉搜尋",
    ...
    sidebar_group_stem: "會話組",
    sidebar_group_rename_placeholder: "會話組名稱",
    sidebar_group_rename_empty: "請輸入會話組名稱。",
    sidebar_group_new_from_selection: "新增會話組",
    sidebar_group_add_to: "加入會話組",
    sidebar_group_remove_from: "移出會話組",
    sidebar_group_dissolve: "解散會話組",
    sidebar_group_auto_continue: "自動繼續（組內全部會話）",
    sidebar_group_merge_panes: "合併面板",
    sidebar_group_split_pane: "分割畫面",
    sidebar_group_confirm_delete: "刪除會話組？",
    sidebar_group_other_worktree: "會話組只能包含同一個 Worktree 下的會話。",
...
pub fn apply_locale(mode: LocaleMode) -> ResolvedLocale {
    ...
    CURRENT_LOCALE.store(locale.code(), Ordering::Relaxed);
    gpui_component::set_locale(locale.tag());
    locale
}

/// The locale the workbench is currently rendering in.
///
/// Reads the value [`apply_locale`] stored; the system tag is not re-parsed on
/// every lookup.
