...
pub fn strings(locale: ResolvedLocale) -> Strings {
    match locale {
        ResolvedLocale::En => Strings {
            ...
            command_palette_placeholder: "Search sessions, settings, and actions",
            ...
            command_palette_no_results: "No matching sessions, settings, or actions",
        ...
        ResolvedLocale::ZhTw => Strings {
            ...
            command_palette_placeholder: "搜尋會話、設定項目與快捷操作",
            command_palette_recent: "最近會話",
            command_palette_sessions: "會話",
            command_palette_settings: "設定",
            command_palette_actions: "快捷操作",
            command_palette_no_results: "沒有符合的會話、設定項目或快捷操作",
