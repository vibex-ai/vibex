...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/status-0.1.0--rc.6-f97316?style=flat" alt="Release status: 0.1.0-rc.6" />
</p>
...
```bash
export VIBEX_RELAY_IMAGE=ghcr.io/vibex-ai/vibex-relay-server:v0.1.0-rc.6
